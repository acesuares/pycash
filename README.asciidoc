...
I use mostly Rapid electronics for my components. Each time I order I at a confimation e-mail. This script, run from an action in claws-mail, creates a GnuCash importable CSV. It also populates my parts-stock database with the purchased items. 
